...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className:
      "max-w-[1200px] px-12 xl:px-0 m-auto w-full py-11 flex justify-between items-center",
    children: [
      /* @__PURE__ */ jsxs("a", {
        href: "/",
      ...
      toggled &&
        ...
        /* @__PURE__ */ jsxs(motion.nav, {
          ...
          className:
            "flex flex-col fixed h-screen bg-white w-[75%] md:w-[90%] text-black bottom-0 left-0 gap-6 items-center justify-center",
          children: [
            /* @__PURE__ */ jsx("a", {
              href: "/",
              className: linkStyle,
...
const Footer = () => {
  return /* @__PURE__ */ jsx("footer", {
    className: "mt-[135px] w-full",
    children: /* @__PURE__ */ jsxs("div", {
      className:
        "w-full max-w-[1200px] px-12 xl:px-0 mx-auto pb-[135px] grid grid-cols-1 lg:grid-cols-5 md:grid-cols-2 gap-6",
      children: [
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", {
              className:
                "tracking-tight text-base lg:text-[22px] lg:leading-[33px] font-jost text-text-gray pt-[18px] pb-[33px]",
              children:
                "It is a long established fact that a reader will be distracted lookings.",
            }),
            /* @__PURE__ */ jsxs("div", {
              className: "flex gap-5 md:gap-[54px]",
              children: [
                /* @__PURE__ */ jsx("a", {
                  href: "/",
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsx("h5", {
              className:
                "text-primary-200 font-dm text-[22px] lg:text-[25px] leading-loose",
              children: "Pages",
            }),
            /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsx("a", {
                  href: "/about",
                  className:
                    "tracking-tight text-base lg:text-[22px] lg:leading-[33px] font-jost text-text-gray",
                  children: "About Us",
                }),
                /* @__PURE__ */ jsx("a", {
                  href: "/services",
            ...
            /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsx("p", {
                  className:
                    "tracking-tight text-base lg:text-[22px] lg:leading-[33px] font-jost text-text-gray",
                  children: "55 East Birchwood Ave. Brooklyn, New York 11201",
                }),
                /* @__PURE__ */ jsx("p", {
                  className:
                    "tracking-tight text-base lg:text-[22px] lg:leading-[33px] font-jost text-text-gray",
                  children: "contact@interno.com",
                }),
                /* @__PURE__ */ jsx("p", {
                  className:
                    "tracking-tight text-base lg:text-[22px] lg:leading-[33px] font-jost text-text-gray",
...
const $$MainLayout = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta name="description" content="Interior Design Website Template"><meta${addAttribute(
      title,
      "title"
      ...
      Navbar,
      {
        ...
        "client:component-path":
          "C:/Users/USER-PC/Desktop/interior-design-website/src/components/navbar.tsx",
        "client:component-export": "default",
      }
    )}${renderSlot(
      $$result,
      $$slots["default"]
    )}<!-- All different pages to be rendered here -->${renderComponent(
      $$result,
      "Footer",
      Footer,
      {}
    )}</main><p class="tracking-tight text-base text-center border border-gray-300 bg-white py-10 lg:text-[22px] lg:leading-[33px] font-jost text-text-gray">
Copyright © Interno | Designed by Onwudebelu Prisca Ebubechukwu
</p></body></html>`;
  },
  "C:/Users/USER-PC/Desktop/interior-design-website/src/layouts/main-layout.astro",
  void 0
);
...
const QuoteText = ({ text, name }) => {
  return /* @__PURE__ */ jsxs("div", {
    className: "flex w-full max-w-full lg:max-w-[80%]",
    children: [
      /* @__PURE__ */ jsx(LeftPattern, {}),
      /* @__PURE__ */ jsxs("div", {
        className:
          "flex flex-col w-full items-center justify-center gap-4 lg:gap-8 lg:mx-[-30px]",
        children: [
          /* @__PURE__ */ jsx(Quote, {}),
          /* @__PURE__ */ jsx("h4", {
            className:
              "text-[20px] leading-[33px] lg:text-[35px] lg:leading-[43.75px] italic tracking-wide font-dm text-primary-200 text-center",
            children: text,
          }),
          /* @__PURE__ */ jsxs("p", {
            className:
              "text-text-gray text-base tracking-tight lg:text-[25px] font-jost lg:leading-[37px] text-center ",
            children: [" ", `-${name}`, " "],
          }),
        ],
      }),
...
const $$About = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      "MainLayout",
      $$MainLayout,
      { title: "Interior Design About Us", "data-astro-cid-kh7btl4r": true },
      {
        default: ($$result2) =>
          renderTemplate`${maybeRenderHead()}<section class="w-full bg-about h-[50vh] flex justify-center items-end" data-astro-cid-kh7btl4r><div class="py-[30px] lg:py-[41px] px-[60px] lg:px-[152px] flex flex-col justify-center items-center bg-white rounded-tl-[37px] rounded-tr-[37px] gap-2.5" data-astro-cid-kh7btl4r><h1 class="text-[30px] leading-[40px] lg:text-[50px] lg:leading-[62px] font-dm capitalize text-primary-200 " data-astro-cid-kh7btl4r>About Us</h1><p class="text-base lg:text-[22px] lg:leading-[33px] tracking-tight font-jost text-text-gray" data-astro-cid-kh7btl4r><a href="/" data-astro-cid-kh7btl4r>Home</a> / About Us </p></div></section><section class="w-full px-12 lg:px-0 pt-[100px] lg:pt-[200px] lg:max-w-[1200px] mx-auto flex items-center justify-center" data-astro-cid-kh7btl4r>${renderComponent(
            $$result2,
            "QuoteText",
            QuoteText,
            {
              text: "I like an interior that defies labeling. I don't really want someone to walk into a room and know that I did it",
              name: "BUNNY WILLIAMS",
              "data-astro-cid-kh7btl4r": true,
            }
          )}</section><section class="w-full pt-[100px] lg:pt-[150px] px-12 lg:px-0 mx-auto lg:max-w-[1200px] " data-astro-cid-kh7btl4r><div class="w-full flex flex-col-reverse lg:flex-row justify-between gap-10 items-center" data-astro-cid-kh7btl4r><div class="flex flex-col gap-6" data-astro-cid-kh7btl4r><h2 class="text-[30px] text-center lg:text-left font-dm tracking-wide capitalize leading-8 md:leading-[62.50px] md:text-[50px] text-text-blue " data-astro-cid-kh7btl4r>We what we do</h2><p class="text-base md:text-[22px] lg:max-w-[85%] text-center lg:text-left tracking-tight font-jost text-text-gray leading-[33px]" data-astro-cid-kh7btl4r>It is a long established fact that a reader will be distracted by the of readable content of a page when lookings at its layouts the points of using that it has a more-or-less normal.</p></div><img src="/about1.png" alt="" data-astro-cid-kh7btl4r></div></section><section class="w-full pt-[100px] lg:pt-[150px] px-12 lg:px-0 mx-auto lg:max-w-[1200px] " data-astro-cid-kh7btl4r><div class="w-full flex flex-col-reverse lg:flex-row-reverse justify-between gap-24 items-center" data-astro-cid-kh7btl4r><div class="flex flex-col gap-6" data-astro-cid-kh7btl4r><h2 class="text-[30px] text-center lg:text-left font-dm tracking-wide capitalize leading-8 md:leading-[62.50px] md:text-[50px] text-text-blue " data-astro-cid-kh7btl4r>The End Result</h2><p class="text-base md:text-[22px] lg:max-w-[95%] text-center lg:text-left tracking-tight font-jost text-text-gray leading-[33px]" data-astro-cid-kh7btl4r>It is a long established fact that a reader will be distracted by the of readable content of a page when lookings at its layouts the points of using that it has a more-or-less normal.</p></div><img src="/about2.png" alt="" data-astro-cid-kh7btl4r></div></section><section class="w-full py-[100px] lg:py-[185px] mt-[173px] px-12 lg:px-0 mx-auto bg-primary-300 " data-astro-cid-kh7btl4r><div class="w-full flex flex-col gap-10 lg:max-w-[1200px] mx-auto" data-astro-cid-kh7btl4r><h2 class="font-dm tracking-wide text-center leading-[37px] lg:leading-[62.50px] text-[30px] lg:text-[50px] w-full lg:max-w-[50%] pb-9 mx-auto" data-astro-cid-kh7btl4r>What the People Thinks About Us</h2><div class="flex w-full overflow-x-scroll gap-4 flex-row no-scrollbar" data-astro-cid-kh7btl4r><img src="/person1.png" alt="" data-astro-cid-kh7btl4r><img src="/person2.png" alt="" data-astro-cid-kh7btl4r><div class="flex flex-col gap-10 w-full justify-between py-[70px] px-7 bg-white min-w-[284px] items-center rounded-[32px]" data-astro-cid-kh7btl4r><p class="flex flex-col tracking-tight leading-9 text-center" data-astro-cid-kh7btl4r><span class="text-primary-200 text-lg lg:text-[25px] font-dm" data-astro-cid-kh7btl4r>Nattasha Julie</span><span class="text-text-gray-200 text-base lg:text-lg font-jost" data-astro-cid-kh7btl4r> Design, Australia</span></p><div class="flex gap-6" data-astro-cid-kh7btl4r><a href="/" data-astro-cid-kh7btl4r>${renderComponent(
            $$result2,
            "Facebook",
            Facebook,
            { "data-astro-cid-kh7btl4r": true }
          )}</a><a href="/" data-astro-cid-kh7btl4r>${renderComponent(
            $$result2,
            "Twitter",
            Twitter,
            { "data-astro-cid-kh7btl4r": true }
            ...
            Instagram,
            { "data-astro-cid-kh7btl4r": true }
          )}</a></div><p class="flex flex-col tracking-tight leading-9 text-center" data-astro-cid-kh7btl4r><span class="text-text-gray-200 text-base lg:text-lg font-jost" data-astro-cid-kh7btl4r> +1 (378) 400-1234</span><span class="text-text-gray-200 text-base lg:text-lg font-jost" data-astro-cid-kh7btl4r> julie@email.com</span></p></div><img src="/person3.png" alt="" data-astro-cid-kh7btl4r></div></div></section>`,
      }
    )}`;
  },
  "C:/Users/USER-PC/Desktop/interior-design-website/src/pages/about.astro",
  void 0
);
